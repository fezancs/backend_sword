...
var homesliderRouter = require('./routes/homeslider');
var displaypopularsearchesRouter = require('./routes/displaypopularsearches');
var selectiveproductsRouter = require('./routes/selectiveproducts');
var productsbytypeRouter = require('./routes/productsbytype');
var displayinstaRouter = require('./routes/displayinsta');
...
app.use('/displaypopularsearches', displaypopularsearchesRouter);
app.use('/selectiveproducts', selectiveproductsRouter);
app.use('/productsbytype', productsbytypeRouter);
app.use('/displayinsta',displayinstaRouter);
